...
public class Sampladiv {



    public static void main(String[] args) throws Exception {

        String spreadsheetId = "1tj-OP3aZuUVvjKcO4clEUINJN2ONIS6qo-5PuzKdmNw";
        String range = "Sheet3!A2:D1000";
        ...
        try (Playwright playwright = Playwright.create()) {
            ...
            page.selectOption("#ContentPlaceHolder1_ddldivision", "D0045");
                            ...
                            try {
                                ...
                                if (partialMatch) {
                                    ...
                                    if (!candidateStatus.isEmpty()) {
                                        ...
                                        continue; // agle match ke liye continue
                                    }

                                    // Empty status wali row mili!
